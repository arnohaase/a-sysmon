  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $destroy: function() {
        ...
        // see: https://github.com/angular/angular-1.2.3.js/issues/1313#issuecomment-10378451
...
function $SnifferProvider() {
  this.$get = ['$window', '$document', function($window, $document) {
    ...
    return {
      ...
      // https://github.com/angular/angular-1.2.3.js/issues/904
 ...
 *   https://github.com/angular/angular-1.2.3.js/pull/2902
 ...
 * of the browser view.
 *
 * `ngCloak` works in cooperation with the following css rule embedded within `angular-1.2.3.js` and
 * `angular.min.js`.
 ...
 *
 * For the best result, the `angular-1.2.3.js` script must be loaded in the head section of the html
 ...
 * These rules are bundled with angular-1.2.3.js, but can be overridden
